...
# Clear any system path cache issues
...
switch ($TIER_CHOICE) {
    1 {
        ...
        $CHECKPOINT_URL_REALISM = "https://civitai.red/api/download/models/2831949?fileId=2718327"
        $CHECKPOINT_URL_ANIME = "https://civitai.red/api/download/models/2824082?fileId=2710895"
    ...
    3 {
        ...
        $CHECKPOINT_URL_REALISM = "https://civitai.red/api/download/models/915814?fileId=1155723"
        $CHECKPOINT_URL_ANIME = "https://civitai.red/api/download/models/948699?fileId=855570"
...
if ($GATEWAY -ne "cloud") {
    ...
    if ($TIER_CHOICE -eq 3) {
        ...
        if ($STYLE -match "Realistic") {
            ...
            $LORA_SUFFIX = "pony"
            Download-File "https://civitai.red/api/download/models/722891?fileId=637489" "$ROOT_DIR\models\loras\shirtlift_pony.safetensors"
            Download-File "https://civitai.red/api/download/models/1539931?fileId=1440591" "$ROOT_DIR\models\loras\missionary_pony.safetensors"
            Download-File "https://civitai.red/api/download/models/651397?fileId=792936" "$ROOT_DIR\models\loras\doggy_pony.safetensors"
            Download-File "https://civitai.red/api/download/models/609983?fileId=792936" "$ROOT_DIR\models\loras\cowgirl_pony.safetensors"
        }
    }
}
...
# === 8. Multi-Modal Lifecycle Engine Runner Generation ===
